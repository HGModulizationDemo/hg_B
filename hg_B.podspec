...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/HGModulizationDemo/hg_B"
  ...
  s.source       = { :git => "https://github.com/HGModulizationDemo/hg_B.git", :tag => s.version.to_s }
